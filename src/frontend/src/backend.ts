...
import type { ExternalBlob as _ExternalBlob, PDFMetadata as _PDFMetadata, Time as _Time, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPDF(arg0: string, arg1: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addPDF(arg0, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPDFs(): Promise<Array<PDFMetadata>> {
        if (this.processError) {
            try {
...
async function from_candid_PDFMetadata_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PDFMetadata): Promise<PDFMetadata> {
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PDFMetadata>): Promise<Array<PDFMetadata>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PDFMetadata_n12(_uploadFile, _downloadFile, x)));
}
