...
const videos: VideoItem[] = [
  {
    ...
    description: 'Master the concepts of relations, types of functions, and their properties for Class 12.',
    chapter: 'Chapter 1',
  ...
  },
  {
    ...
    description: 'Learn all inverse trig functions, their domains, ranges, and important formulas.',
    chapter: 'Chapter 2',
    youtubeId: 'dQw4w9WgXcQ',
  },
  {
    ...
    description: 'Understand matrix types, addition, multiplication, and transpose with solved examples.',
    chapter: 'Chapter 3',
    youtubeId: 'dQw4w9WgXcQ',
  },
  {
    ...
    description: 'Explore determinant properties, cofactors, adjoint, and inverse of a matrix.',
    chapter: 'Chapter 4',
    youtubeId: 'dQw4w9WgXcQ',
  },
  {
    ...
    description: 'Deep dive into continuity, differentiability, chain rule, and implicit differentiation.',
    chapter: 'Chapter 5',
    youtubeId: 'dQw4w9WgXcQ',
  },
  {
    ...
    description: 'Rate of change, increasing/decreasing functions, maxima, minima, and tangents.',
    chapter: 'Chapter 6',
    youtubeId: 'dQw4w9WgXcQ',
  },
];
  ...
  return (
    <div className="bg-site-card border border-white/10 rounded-2xl overflow-hidden hover:border-brand-fire/40 transition-all duration-300 hover:shadow-xl hover:shadow-brand-fire/10 group flex flex-col">
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <p className="text-white/50 text-sm leading-relaxed flex-1">{video.description}</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-white/60 text-lg max-w-2xl mx-auto">
            Comprehensive video lectures covering the entire CBSE Class 12 Mathematics syllabus. 
            Clear explanations, solved examples, and exam-focused content.
          </p>
        </div>
