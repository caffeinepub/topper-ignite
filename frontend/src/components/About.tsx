...
const features = [
  {
    ...
    description: 'Every concept is taught with CBSE board exams in mind — important questions, marking schemes, and shortcuts.',
  },
  {
    icon: Lightbulb,
    title: 'Concept Clarity First',
    description: 'We believe in building strong fundamentals before moving to complex problems. No rote learning!',
  },
  {
    icon: Trophy,
    title: 'Proven Results',
    description: 'Thousands of students have scored 90+ in Class 12 Math after following our structured video series.',
  },
  {
    icon: Heart,
    title: 'Free for Everyone',
    description: 'Quality education should be accessible to all. All our videos are completely free on YouTube.',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-white/60 text-lg max-w-2xl mx-auto">
            A dedicated YouTube channel helping Class 12 students conquer Mathematics 
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div>
            <h3 className="font-heading font-black text-3xl text-white mb-6 leading-tight">
              Igniting the{' '}
              <span className="text-brand-fire">spark of learning</span>{' '}
              in every student
            </h3>
            <div className="space-y-4 text-white/70 text-base leading-relaxed">
              <p>
                <strong className="text-white">Topper Ignite</strong> is a YouTube channel dedicated to making 
                Class 12 Mathematics simple, engaging, and effective. We cover the complete CBSE syllabus 
                through well-structured video lectures that are easy to follow.
              </p>
              <p>
                Our teaching approach focuses on building conceptual understanding first, then applying 
                it to solve board-level and competitive exam problems. Whether you're struggling with 
                Calculus or Vectors, we've got you covered.
              </p>
              <p>
                Join thousands of students who have transformed their Math scores by learning with 
                Topper Ignite. Subscribe to our channel and never miss a new lecture!
              </p>
            </div>
            <div className="mt-8">
              <a
            ...
            <div className="grid grid-cols-1 gap-2">
              {chapters.map((chapter, index) => (
                ...
                >
                  ...
                  <span className="text-white/80 text-sm font-medium">{chapter}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {features.map((feature) => {
            ...
            return (
              ...
              >
                ...
                <h4 className="font-heading font-bold text-white text-base mb-2">{feature.title}</h4>
