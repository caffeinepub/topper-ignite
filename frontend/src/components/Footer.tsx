...
const appId = encodeURIComponent(typeof window !== 'undefined' ? window.location.hostname : 'topper-ignite');
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <img
                ...
                className="h-12 w-12 rounded-full object-cover ring-2 ring-brand-fire/60 shadow-md shadow-brand-fire/30"
              />
              <div className="flex flex-col leading-none">
                <span className="font-heading font-black text-lg text-white tracking-tight">TOPPER</span>
                <span className="font-heading font-black text-lg text-brand-fire tracking-widest -mt-1">IGNITE</span>
              </div>
            </div>
            <p className="text-white/50 text-sm leading-relaxed max-w-xs">
              Your go-to YouTube channel for Class 12 Mathematics. Free, clear, and exam-focused video lectures.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={topic} className="text-white/50 text-sm flex items-center gap-2">
